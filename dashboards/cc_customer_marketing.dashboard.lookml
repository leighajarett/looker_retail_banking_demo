- dashboard: cc_customer_marketing
  ...
  - title: Transactions by Card Type
    ...
    width: 12
    height: 10
  - name: "<span class='fa fa-tachometer'> KPI Overview </span>"
    type: text
    title_text: "<span class='fa fa-tachometer'> KPI Overview </span>"
  ...
  - title: Number of Lost Customers
    ...
    filters:
      card.end_quarter: before 0 days ago
  ...
  - title: Spend by Transaction Category
    ...
    fields: [card_transactions.category, client.age_tier, card_transactions.total_amount]
    pivots: [card_transactions.category]
    filters:
      client.age_tier: "-Undefined"
    sorts: [card_transactions.category 0, client.age_tier]
    limit: 500
    column_limit: 50
    show_value_labels: false
    font_size: '12'
  ...
  - title: Card Overview
    ...
    explore: card_payments
    type: looker_grid
    fields: [card_payments.average_amount_owed, card_payments.total_interest_charged,
      card.type, card_type.total_annual_fee, card_type.annual_fee, card.number_of_credit_cards,
      card_type.APR]
  ...
  - title: Interest by Age & Gender
    ...
    y_axes: [{label: '', orientation: left, series: [{axisId: card_payments.total_interest_charged,
        ...
        type: linear}]
    series_colors:
      F - card_payments.total_interest_charged: "#7363A9"
    defaults_version: 1
    row: 30
    col: 0
    width: 8
