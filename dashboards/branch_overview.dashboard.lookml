- dashboard: branch_overview
  ...
  - title: Attrition Rate
    ...
    note_state: collapsed
    note_display: below
    note_text: Total outflow over balance at beginning of peiod
    listen:
      Date: balances_fact.balance_date
    row: 4
    col: 12
  ...
  - title: Inflow Rate
    ...
    width: 6
    height: 4
  - title: Number New Clients
    name: Number New Clients
    model: retail_banking
    explore: trans
    type: single_value
    fields: [account.number_of_accounts]
    filters:
      account.create_date: 5 months
    limit: 500
    column_limit: 50
    custom_color_enabled: true
    show_single_value_title: true
  ...
  - name: Credit Cards
    ...
    subtitle_text: ''
    body_text: "[Card Overview Dashboard](/dashboards/7QMprcICQHCGIOARQ7LHbx)"
    row: 32
    col: 0
    width: 11
    height: 2
