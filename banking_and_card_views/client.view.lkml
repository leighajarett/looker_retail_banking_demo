view: client {
  ...
  dimension: name {
    ...
    link: {
      ...
      url: "/dashboards-next/426?Name={{ value | encode_uri }}"
      icon_url: "https://image.flaticon.com/icons/svg/485/485414.svg"
    }
  ...
  dimension: zip {
    ...
    dimension: client_address_street_view {
      type: string
      group_label: "Address"
      sql: ${client_full_address} ;;
